...
export const Widget = ({ widget }: WidgetProps) => {
    return (
        <div className={styles.widget}>
            ...
            {widget.progressValue ? <LinearProgress variant="determinate" value={widget.progressValue} sx={{ marginTop: '38px', borderRadius: '100px', height: '8px', backgroundColor: 'transparent' }} /> : <div />}
